...
# Created with the help of Zac, Gunner, Nate, and 
# import package
...
def show_rock(x,y):
    ...
    # attach the rock_image to the rock_instanc
...
#Randomly selects an item from the 'compchoices' list and returns it as a string.
...
#This function hides the turtle graphics for 'paper_instance', 'rock_instance', and 'scissors_instance'.
...
#Function to handle mouse click events at position (x, y).
...
#Check if there is a collision between a point (x, y) and the 'rock_instance' object.
...
#Check if the computer's choice is 'Rock' and handle the game outcome accordingly.
...
# Check if the computer's choice is 'Paper' and handle the game outcome accordingly.
...
#Check if the computer's choice is 'Scissors' and handle the game outcome accordingly.
...
# Check if there is a collision between a point (x, y) and the 'scissors_instance' object.
...
# Handle the case where the player's choice is not recognized or specified as "non-gui."
